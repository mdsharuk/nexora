...
export const FlashIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const BuildIcon: React.FC<IconProps> = ({ className, size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const HomeIcon: React.FC<IconProps> = ({ className, size = 14 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
